...
export const siteConfig = {
    ...
    linkedin: "https://linkedin.com/in/abuzubayer", // Placeholder
    phone: "+880 1234 567 890", // Placeholder
};

export const heroContent = {
    headline: "Elevating Customer Experience through Empathy & Precision.",
    subheadline: "Customer Service Specialist & English Literature Scholar.",
...
export const experienceData = [
    {
        ...
        type: "contract",
        skills: ["Healthcare Ops", "Patient Relations", "Info Management"]
    },
    {
        ...
        type: "full-time",
        skills: ["Telecom Support", "CRM", "Call Handling"]
    },
    {
        ...
        type: "full-time",
        skills: ["Trade Marketing", "Retail Relations", "Field Sales"]
    }
];
...
export const contactData = {
    ...
    text: "Open to opportunities in Customer Service, Telecommunications, and Corporate Operations.",
};
